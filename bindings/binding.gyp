                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@databrainhq/node-bindings-linux-x64",
                            },
                        ],
                    },
                ],
                [
                    'OS=="linux" and target_arch=="arm64"',
                    {
                        ...
                        "copies": [
                            {
                                "files": ["<(module_root_dir)/libduckdb/libduckdb.so"],
                                "destination": "<(module_root_dir)/pkgs/@databrainhq/node-bindings-linux-arm64",
                            },
                        ],
                    },
                ],
                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@databrainhq/node-bindings-darwin-arm64",
                            },
                        ],
                    },
                ],
                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@databrainhq/node-bindings-darwin-x64",
                            },
                        ],
                    },
                ],
                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@databrainhq/node-bindings-win32-x64",
                            },
                        ],
                    },
                ],
